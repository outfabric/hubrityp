...
function asActiveUser() {
  // active + !requires_password_reset -- the middleware resolves the profile
  // and never calls getUser() again, so only the profile mock matters.
...
describe('middleware onboarding wizard route gating', () => {
  ...
  // =====================================================================
  // Positive-auth: active psychologist passes through
  // =====================================================================
