 ...
 * visitor without JavaScript sees all five answers expanded and readable, and
 ...
 *
 * Leaf Client Component: it carries only presentational FAQ copy from the content
 * layer — no PII, no secrets, nothing fetched.
 */
  ...
  return (
    <section aria-labelledby="faq-title" className="py-16 md:py-24">
      <Container className="flex flex-col items-center gap-10">
        <h2 id="faq-title" className="text-display-md text-text-primary max-w-2xl text-center">
