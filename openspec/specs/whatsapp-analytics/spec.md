# whatsapp-analytics Specification

## Purpose

Analytics dashboard for WhatsApp messaging with monthly summary cards (sent, delivery/read/confirmation rates, estimated cost), searchable message history table, and configurable template pricing.
