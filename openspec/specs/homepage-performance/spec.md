# homepage-performance Specification

## Purpose

Defines the public homepage performance and accessibility budget: Lighthouse/LCP/CLS targets and image optimization, `prefers-reduced-motion` compliance, and responsive integrity from 320px to 1920px. Created by syncing change `public-homepage`.
