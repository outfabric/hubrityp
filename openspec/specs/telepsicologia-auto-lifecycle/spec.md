...
Automated lifecycle management for telepsychology video rooms: auto-creation of rooms when sessions are set to online, expiration of rooms when sessions change modality, cron-based cleanup of expired and empty rooms, and cron-based discarding of old recording audio.
