# whatsapp-reminder-settings Specification

## Purpose

Psychologist-configurable reminder windows (early, final, video link), night-shift rule, and the settings UI page for managing WhatsApp reminder preferences.
