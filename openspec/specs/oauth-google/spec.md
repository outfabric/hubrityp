...
- **THEN** the button exposes `data-testid="login-form-google-button"` and uses an icon from the design system's iconography map (or shadcn-compatible Google glyph)
