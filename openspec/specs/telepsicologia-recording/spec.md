# telepsicologia-recording Specification

## Purpose

Recording controls for telepsychology sessions: consent-gated start/stop of Stream recording, patient-facing recording banner, session extension, and compliance with Res. CFP 13/2022.
