# ai-transcription-data-model Specification

## Purpose

Defines the Postgres tables, RLS policies, operational indexes, and private Storage bucket that support the AI transcription feature. Created by syncing change `ai-transcription-foundation`.
