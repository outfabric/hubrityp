# telepsicologia-prontuario-drawer Specification

## Purpose

Prontuario side drawer during video calls: psychologist-only access to recent evolutions and quick evolution creation form, RLS-scoped data access via existing prontuario module Server Components, auto-save with timestamp indicator.
