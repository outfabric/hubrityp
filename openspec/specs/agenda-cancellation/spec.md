# agenda-cancellation Specification

## Purpose

Structured session cancellation with reason tracking, reschedule as cancel-and-replace, no-show handling, session reactivation, and soft-delete for unused sessions.
