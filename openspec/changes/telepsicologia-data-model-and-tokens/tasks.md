...
- [x] 5.4 **Integration test:** Create `src/__tests__/integration/telepsicologia/get-video-token.int.test.ts` — mock Stream SDK. Tests: happy path returns token, room not owned -> rejected, room expired -> rejected, unauthenticated -> rejected
