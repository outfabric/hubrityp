...
- [Integration before e2e wipes seed](feedback_integration_before_e2e_wipes_seed.md) — test:integration full then test:e2e:seeded reuses the SAME container; integration cleanup empties patients → 40+ false e2e fails (0ms first-in-file); docker rm -f between them, verify seed=15
